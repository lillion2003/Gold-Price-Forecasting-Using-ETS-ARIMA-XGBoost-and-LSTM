...
- จากการทดลองเปลี่ยนชุดค่าพารามิเตอร์ที่ค้นหาของ XGBoost พบว่าไม่ทำใหความแม่นยำเปลี่ยนแปลงมากนัก ในขณะที่วิธี LSTM ในแต่ละชุดพารามิเตอร์ที่ดีที่สุดของแต่ละรอบการค้นหาเมื่อนำไปสร้างโมเดลแล้ววัดผลจริง พบว่าบางครั้งโมเดลก็มีความแม่นยำสูงมาก (มีความแม่นยำสูงที่สุดจาก 4 วิธี) บางชุดค่าพารามิเตอร์ที่ได้จากการค้นหาเมื่อนำไปสร้างโมเดลจริงกลับมีความแม่นยำต่ำมาก (ต่ำที่สุดจาก 4 โมเดล) หมายความว่าโมเดลที่สร้างจาก LSTM มีความอ่อนไหวต่อค่าไฮเพอร์พารามิเตอร์อย่างมาก ซึ่งอาจเป็นเพราะโดยทั่วไปแล้วโมเดล Deep Learning จะเหมาะสำหรับข้อมูลจำนวนมาก แต่ XGBoost ที่ความแม่นยำมีความเสถียรแม้เปลี่ยช่วงหาไฮเพอร์พารามิเตอร์อาจเป็นเพราะถึงข้อมูลจะน้อยแต่มีความเพียงพอต่อการฝึกโมเดล
